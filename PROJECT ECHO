...
while True:
    ...
    negs = ["no", "not", "stress", "boring", "meh", "unpleasant", "tiring", "frustrating", "disappointing", "difficult", "hectic", "bad", "sad", "upset", "worry", "annoying", "overwhelming", "weary", "challenging", "tedious", "exhausting"]
    nets = ["ok", "plain", "okay", "fine", "average", "decent", "normal", "routine", "regular", "fair", "so-so", "meh", "alright", "satisfactory", "tolerable", "moderate", "middling", "adequate", "mediocre", "passable", "unremarkable", "ordinary", "standard", "usual", "simple", "basic", "standard"]
    ...
    health_input = input(f"{n}, how is your physical health today? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if any(word in health_input.lower() for word in negs):
        print("I'm sorry to hear that. Take it easy and don't forget to prioritize your well-being.")
    elif any(word in health_input.lower() for word in nets):
    ...
    elif any(word in health_input.lower() for word in pots):
    ...
    mental_health_input = input(f"{n}, how is your mental health today? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if any(word in mental_health_input.lower() for word in negs):
        print('''I'm sorry to hear that. It's okay not to be okay. 
           If you need to talk or take a break, feel free to do so.''')
    elif any(word in mental_health_input.lower() for word in nets):
    ...
    elif any(word in mental_health_input.lower() for word in pots):
    ...
    study_input = input(f"{n}, what are you currently studying or working on? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
     I'm just a message away. Have a fantastic day!\n''')
    break
    if study_input:
        print(f'''Ah, {n}, studying {study_input} sounds fascinating. Learning is a lifelong journey, 
                      and it's wonderful that you're engaged in.''')
    else:
    ...
    future_plans_input = input(f"{n}, what do you plan to do after your current studies or projects? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if future_plans_input:
        print(f'''Interesting plans, {future_plans_input}! It's exciting to think about the future. 
    ...
    role_models_input = input(f"{n}, do you have any role models or people you look up to? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if role_models_input:
        print(f'''Ah, {role_models_input}! That's wonderful. Role models can inspire and guide us. 
               What qualities in {role_models_input} do you admire the most?''')
    else:
    ...
    favorite_book_input = input(f"{n}, do you have a favorite book? If so, what is it? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if favorite_book_input:
        print(f'''Ah, {favorite_book_input}! That's an excellent choice. 
    ...
    vacation_input = input(f"{n}, do you have a favorite vacation spot or a dream destination you'd like to visit? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if vacation_input:
        print(f'''Fantastic choice, {vacation_input}! There's something magical 
               about that place. What attracts you the most to {vacation_input}?''')
    else:
    ...
    favorite_movie_input = input(f"{n}, do you have a favorite movie? If so, what is it? ")
    if n.lower().strip() == 'over':
        print(f'''\nThank you, {n}, for chatting with ECHO! If you ever need a friendly conversation, 
      I'm just a message away. Have a fantastic day!\n''')
        break
    if favorite_movie_input:
        print(f'''Ah, {favorite_movie_input}! That's a great choice. Movies have a special way of capturing our emotions. 
                What do you love most about {favorite_movie_input}?''')
    else:
